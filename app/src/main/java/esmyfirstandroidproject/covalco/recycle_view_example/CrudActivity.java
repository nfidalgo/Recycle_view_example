...
public class CrudActivity extends Activity implements View.OnClickListener,
    ...
    //Declaracion del spinner y su Adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Creamos el adapter y lo asociamos el spinner
        ...
        //Añadimos la validacion al formulario
        ...
        switch(v.getId()){
            case R.id.btnCrear:
                if(awesomeValidation.validate()){
                    ...
                    lista=db.getComents();
                    //Actualizamos el adapter y lo asociamos al nuevo spinner
                    spinnerAdapter=new ArrayAdapter(this,android.R.layout.simple_spinner_dropdown_item,lista);
                    spinComentarios.setAdapter(spinnerAdapter);

                    //Mostrem missatge
                    Toast.makeText(this,"Lo has echo genial",Toast.LENGTH_LONG).show();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (parent.getId() == R.id.spinComentarios){
            //Si hay elementos en la base de datos, establecemos el comentario actual a partir del indice
